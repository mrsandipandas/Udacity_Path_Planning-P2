 ...
 * The planner should drive the car inside of the marked road lanes at all times unless going from one lane to another. 
...
["x"] The maps's x waypoint coordinates

["y"] The maps's y waypoint coordinates

["s"] The s value is the distance along the road to get to that waypoint in meters

["dx"] It is the value which defines the unit normal vector pointing outward of the highway loop in x direction

["dy"] It is the value which defines the unit normal vector pointing outward of the highway loop in y direction
...
## Result
![One pass along the track without errors](result/result.png){:style="align: left;}